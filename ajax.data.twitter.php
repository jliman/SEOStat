...
<? for ($i = 0; $i < sizeof($stats); $i++) { ?>
<set value='<?=emptyIfZero(round($stats[$i]['followers']))?>' />
<? } ?>
</dataset>
<dataset seriesName='Tweets'>
<? for ($i = 0; $i < sizeof($stats); $i++) { ?>
<set value='<?=emptyIfZero(round($stats[$i]['tweets']))?>' />
<? } ?>
</dataset>
