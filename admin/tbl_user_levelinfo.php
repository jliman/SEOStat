...
//
// Table class for tbl_user_level
//
class ctbl_user_level {
	var $TableVar = 'tbl_user_level';
	...
	//
	function ctbl_user_level() {
		global $Language;

		// userlevelid
		$this->userlevelid = new cField('tbl_user_level', 'tbl_user_level', 'x_userlevelid', 'userlevelid', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE);
		$this->userlevelid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userlevelid'] =& $this->userlevelid;

		// userlevelname
		$this->userlevelname = new cField('tbl_user_level', 'tbl_user_level', 'x_userlevelname', 'userlevelname', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE);
	...
	function HighlightName() {
		return "tbl_user_level_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `tbl_user_level` ($names) VALUES ($values)";
	}
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `tbl_user_level` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("tbl_user_levelview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "tbl_user_leveladd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("tbl_user_leveledit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("tbl_user_leveladd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("tbl_user_leveldelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=tbl_user_level" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
