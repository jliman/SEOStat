...
class ctbl_group {
	...
	function ctbl_group() {
		...
		// id
		$this->id = new cField('tbl_group', 'tbl_group', 'x_id', 'id', '`id`', 19, -1, FALSE, '`id`', FALSE);
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// name
		$this->name = new cField('tbl_group', 'tbl_group', 'x_name', 'name', '`name`', 200, -1, FALSE, '`name`', FALSE);
		$this->fields['name'] =& $this->name;

		// is_active
		$this->is_active = new cField('tbl_group', 'tbl_group', 'x_is_active', 'is_active', '`is_active`', 202, -1, FALSE, '`is_active`', FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `tbl_group` ($names) VALUES ($values)";
	}
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `tbl_group` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("tbl_groupview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "tbl_groupadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("tbl_groupedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("tbl_groupadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("tbl_groupdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=tbl_group" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
