...
$tbl_user_level_permissions = NULL;

//
// Table class for tbl_user_level_permissions
//
class ctbl_user_level_permissions {
	var $TableVar = 'tbl_user_level_permissions';
	...
	//
	function ctbl_user_level_permissions() {
		global $Language;

		// userlevelid
		$this->userlevelid = new cField('tbl_user_level_permissions', 'tbl_user_level_permissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE);
		$this->userlevelid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['userlevelid'] =& $this->userlevelid;

		// tablename
		$this->ztablename = new cField('tbl_user_level_permissions', 'tbl_user_level_permissions', 'x_ztablename', 'tablename', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE);
		$this->fields['tablename'] =& $this->ztablename;

		// permission
		$this->permission = new cField('tbl_user_level_permissions', 'tbl_user_level_permissions', 'x_permission', 'permission', '`permission`', 3, -1, FALSE, '`permission`', FALSE);
	...
	function HighlightName() {
		return "tbl_user_level_permissions_Highlight";
	}
	...
	function SqlFrom() { // From
		return "`tbl_user_level_permissions`";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `tbl_user_level_permissions` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `tbl_user_level_permissions` SET ";
		foreach ($rs as $name => $value) {
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "tbl_user_level_permissionslist.php";
		}
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("tbl_user_level_permissionsview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "tbl_user_level_permissionsadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("tbl_user_level_permissionsedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("tbl_user_level_permissionsadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("tbl_user_level_permissionsdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=tbl_user_level_permissions" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
