...
//
// Table class for tbl_index_stat
//
class ctbl_index_stat {
	var $TableVar = 'tbl_index_stat';
	...
	//
	function ctbl_index_stat() {
		global $Language;

		// id_profile
		$this->id_profile = new cField('tbl_index_stat', 'tbl_index_stat', 'x_id_profile', 'id_profile', '`id_profile`', 19, -1, FALSE, '`id_profile`', FALSE);
		$this->id_profile->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_profile'] =& $this->id_profile;

		// stat_date
		$this->stat_date = new cField('tbl_index_stat', 'tbl_index_stat', 'x_stat_date', 'stat_date', '`stat_date`', 133, 5, FALSE, '`stat_date`', FALSE);
		$this->stat_date->FldDefaultErrMsg = str_replace("%s", "/", $Language->Phrase("IncorrectDateYMD"));
		$this->fields['stat_date'] =& $this->stat_date;

		// year
		$this->year = new cField('tbl_index_stat', 'tbl_index_stat', 'x_year', 'year', '`year`', 19, -1, FALSE, '`year`', FALSE);
		$this->year->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['year'] =& $this->year;

		// month
		$this->month = new cField('tbl_index_stat', 'tbl_index_stat', 'x_month', 'month', '`month`', 17, -1, FALSE, '`month`', FALSE);
		$this->month->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['month'] =& $this->month;

		// week
		$this->week = new cField('tbl_index_stat', 'tbl_index_stat', 'x_week', 'week', '`week`', 17, -1, FALSE, '`week`', FALSE);
		$this->week->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['week'] =& $this->week;

		// google
		$this->google = new cField('tbl_index_stat', 'tbl_index_stat', 'x_google', 'google', '`google`', 19, -1, FALSE, '`google`', FALSE);
		$this->google->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['google'] =& $this->google;

		// yahoo
		$this->yahoo = new cField('tbl_index_stat', 'tbl_index_stat', 'x_yahoo', 'yahoo', '`yahoo`', 19, -1, FALSE, '`yahoo`', FALSE);
		$this->yahoo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['yahoo'] =& $this->yahoo;

		// bing
		$this->bing = new cField('tbl_index_stat', 'tbl_index_stat', 'x_bing', 'bing', '`bing`', 19, -1, FALSE, '`bing`', FALSE);
		$this->bing->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['bing'] =& $this->bing;
	}
	...
	function HighlightName() {
		return "tbl_index_stat_Highlight";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `tbl_index_stat` ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		global $conn;
		$SQL = "UPDATE `tbl_index_stat` SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM `tbl_index_stat` WHERE ";
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("tbl_index_statview.php", $this->UrlParm());
	}

	// Add URL
	function AddUrl() {
		$AddUrl = "tbl_index_statadd.php";
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("tbl_index_statedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("tbl_index_statadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("tbl_index_statdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=tbl_index_stat" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->yahoo->setDbValue($rs->fields('yahoo'));
		$this->bing->setDbValue($rs->fields('bing'));
	}
   ...
   // Common render codes
		...
		// google
		$this->google->CellCssStyle = ""; $this->google->CellCssClass = "";
		$this->google->CellAttrs = array(); $this->google->ViewAttrs = array(); $this->google->EditAttrs = array();

		// yahoo
		$this->yahoo->CellCssStyle = ""; $this->yahoo->CellCssClass = "";
		$this->yahoo->CellAttrs = array(); $this->yahoo->ViewAttrs = array(); $this->yahoo->EditAttrs = array();

		// bing
		$this->bing->CellCssStyle = ""; $this->bing->CellCssClass = "";
		$this->bing->CellAttrs = array(); $this->bing->ViewAttrs = array(); $this->bing->EditAttrs = array();
		...
		$this->google->CssStyle = "";
		$this->google->CssClass = "";
		$this->google->ViewCustomAttributes = "";

		// yahoo
		$this->yahoo->ViewValue = $this->yahoo->CurrentValue;
		$this->yahoo->CssStyle = "";
		$this->yahoo->CssClass = "";
		$this->yahoo->ViewCustomAttributes = "";

		// bing
		$this->bing->ViewValue = $this->bing->CurrentValue;
		$this->bing->CssStyle = "";
		$this->bing->CssClass = "";
		$this->bing->ViewCustomAttributes = "";
		...
		// yahoo
		$this->yahoo->HrefValue = "";
		$this->yahoo->TooltipValue = "";

		// bing
		$this->bing->HrefValue = "";
		$this->bing->TooltipValue = "";
