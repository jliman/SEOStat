...
// Create page object
$tbl_rank_stat_view = new ctbl_rank_stat_view();
$Page =& $tbl_rank_stat_view;

// Page init
$tbl_rank_stat_view->Page_Init();

// Page main
$tbl_rank_stat_view->Page_Main();
?>
...
// Create page object
var tbl_rank_stat_view = new ew_Page("tbl_rank_stat_view");

// page properties
tbl_rank_stat_view.PageID = "view"; // page ID
tbl_rank_stat_view.FormID = "ftbl_rank_statview"; // form ID
var EW_PAGE_ID = tbl_rank_stat_view.PageID; // for backward compatibility

// extend page with Form_CustomValidate function
tbl_rank_stat_view.Form_CustomValidate =  
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
tbl_rank_stat_view.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
	ew_ClickAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
tbl_rank_stat_view.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
tbl_rank_stat_view.ValidateRequired = false; // no JavaScript validation
<?php } ?>

// search highlight properties
tbl_rank_stat_view.ShowHighlightText = ewLanguage.Phrase("ShowHighlight"); 
tbl_rank_stat_view.HideHighlightText = ewLanguage.Phrase("HideHighlight");
...
<?php } ?>
<p><span class="phpmaker"><?php echo $Language->Phrase("View") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $tbl_rank_stat->TableCaption() ?>
<br><br>
<?php if ($tbl_rank_stat->Export == "") { ?>
<a href="<?php echo $tbl_rank_stat_view->ListUrl ?>"><?php echo $Language->Phrase("BackToList") ?></a>&nbsp;
<?php if ($Security->CanAdd()) { ?>
<a href="<?php echo $tbl_rank_stat_view->AddUrl ?>"><?php echo $Language->Phrase("ViewPageAddLink") ?></a>&nbsp;
<?php } ?>
<?php if ($Security->CanEdit()) { ?>
<a href="<?php echo $tbl_rank_stat_view->EditUrl ?>"><?php echo $Language->Phrase("ViewPageEditLink") ?></a>&nbsp;
<?php } ?>
<?php if ($Security->CanAdd()) { ?>
<a href="<?php echo $tbl_rank_stat_view->CopyUrl ?>"><?php echo $Language->Phrase("ViewPageCopyLink") ?></a>&nbsp;
<?php } ?>
<?php if ($Security->CanDelete()) { ?>
<a onclick="return ew_Confirm(ewLanguage.Phrase('DeleteConfirmMsg'));" href="<?php echo $tbl_rank_stat_view->DeleteUrl ?>"><?php echo $Language->Phrase("ViewPageDeleteLink") ?></a>&nbsp;
<?php } ?>
<?php } ?>
</span></p>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
$tbl_rank_stat_view->ShowMessage();
?>
<p>
<?php if ($tbl_rank_stat->Export == "") { ?>
...
<table border="0" cellspacing="0" cellpadding="0" class="ewPager">
	<tr>
		<td nowrap>
<?php if (!isset($tbl_rank_stat_view->Pager)) $tbl_rank_stat_view->Pager = new cPrevNextPager($tbl_rank_stat_view->lStartRec, $tbl_rank_stat_view->lDisplayRecs, $tbl_rank_stat_view->lTotalRecs) ?>
<?php if ($tbl_rank_stat_view->Pager->RecordCount > 0) { ?>
	<table border="0" cellspacing="0" cellpadding="0"><tr><td><span class="phpmaker"><?php echo $Language->Phrase("Page") ?>&nbsp;</span></td>
<!--first page button-->
	<?php if ($tbl_rank_stat_view->Pager->FirstButton->Enabled) { ?>
	<td><a href="<?php echo $tbl_rank_stat_view->PageUrl() ?>start=<?php echo $tbl_rank_stat_view->Pager->FirstButton->Start ?>"><img src="images/first.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="images/firstdisab.gif" alt="<?php echo $Language->Phrase("PagerFirst") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
<!--previous page button-->
	<?php if ($tbl_rank_stat_view->Pager->PrevButton->Enabled) { ?>
	<td><a href="<?php echo $tbl_rank_stat_view->PageUrl() ?>start=<?php echo $tbl_rank_stat_view->Pager->PrevButton->Start ?>"><img src="images/prev.gif" alt="<?php echo $Language->Phrase("PagerPrevious") ?>" width="16" height="16" border="0"></a></td>
	<?php } else { ?>
	<td><img src="images/prevdisab.gif" alt="<?php echo $Language->Phrase("PagerPrevious") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
<!--current page number-->
	<td><input type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" id="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $tbl_rank_stat_view->Pager->CurrentPage ?>" size="4"></td>
<!--next page button-->
	<?php if ($tbl_rank_stat_view->Pager->NextButton->Enabled) { ?>
	<td><a href="<?php echo $tbl_rank_stat_view->PageUrl() ?>start=<?php echo $tbl_rank_stat_view->Pager->NextButton->Start ?>"><img src="images/next.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="images/nextdisab.gif" alt="<?php echo $Language->Phrase("PagerNext") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
<!--last page button-->
	<?php if ($tbl_rank_stat_view->Pager->LastButton->Enabled) { ?>
	<td><a href="<?php echo $tbl_rank_stat_view->PageUrl() ?>start=<?php echo $tbl_rank_stat_view->Pager->LastButton->Start ?>"><img src="images/last.gif" alt="<?php echo $Language->Phrase("PagerLast") ?>" width="16" height="16" border="0"></a></td>	
	<?php } else { ?>
	<td><img src="images/lastdisab.gif" alt="<?php echo $Language->Phrase("PagerLast") ?>" width="16" height="16" border="0"></td>
	<?php } ?>
	<td><span class="phpmaker">&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $tbl_rank_stat_view->Pager->PageCount ?></span></td>
	</tr></table>
<?php } else { ?>
	<?php if ($Security->CanList()) { ?>
	<?php if ($tbl_rank_stat_view->sSrchWhere == "0=101") { ?>
...
<div<?php echo $tbl_rank_stat->id_profile->ViewAttributes() ?>><?php echo $tbl_rank_stat->id_profile->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $tbl_rank_stat->stat_date->ViewAttributes() ?>><?php echo $tbl_rank_stat->stat_date->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $tbl_rank_stat->year->ViewAttributes() ?>><?php echo $tbl_rank_stat->year->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $tbl_rank_stat->month->ViewAttributes() ?>><?php echo $tbl_rank_stat->month->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $tbl_rank_stat->week->ViewAttributes() ?>><?php echo $tbl_rank_stat->week->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $tbl_rank_stat->alexa_rank->ViewAttributes() ?>><?php echo $tbl_rank_stat->alexa_rank->ViewValue ?></div></td>
	</tr>
<?php } ?>
...
<div<?php echo $tbl_rank_stat->google_pagerank->ViewAttributes() ?>><?php echo $tbl_rank_stat->google_pagerank->ViewValue ?></div></td>
	</tr>
<?php } ?>
</table>
</div>
...
<?php
$tbl_rank_stat_view->Page_Terminate();
?>
<?php
...
class ctbl_rank_stat_view {
	...
	// Page object name
	var $PageObjName = 'tbl_rank_stat_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id_profile"] <> "") {
				...
				$this->arRecKey["id_profile"] = $tbl_rank_stat->id_profile->QueryStringValue;
			} else {
				$bLoadCurrentRecord = TRUE;
			}
			if (@$_GET["stat_date"] <> "") {
				$tbl_rank_stat->stat_date->setQueryStringValue($_GET["stat_date"]);
				$this->arRecKey["stat_date"] = $tbl_rank_stat->stat_date->QueryStringValue;
			} else {
				$bLoadCurrentRecord = TRUE;
			}

			// Get action
			$tbl_rank_stat->CurrentAction = "I"; // Display form
			switch ($tbl_rank_stat->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->lTotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("tbl_rank_statlist.php"); // Return to list page
						...
						while (!$rs->EOF) {
							if (strval($tbl_rank_stat->id_profile->CurrentValue) == strval($rs->fields('id_profile')) AND strval($tbl_rank_stat->stat_date->CurrentValue) == strval($rs->fields('stat_date'))) {
								$tbl_rank_stat->setStartRecordNumber($this->lStartRec); // Save record position
								$bMatchRecord = TRUE;
								break;
							} else {
								$this->lStartRec++;
					...
					if (!$bMatchRecord) {
						$this->setMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "tbl_rank_statlist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($rs); // Load row values
					}
			}
		} else {
			$sReturnUrl = "tbl_rank_statlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
			$this->Page_Terminate($sReturnUrl);

		// Render row
		$tbl_rank_stat->RowType = EW_ROWTYPE_VIEW;
		$this->RenderRow();
	}
	...
	function RenderRow() {
		...
		// Initialize URLs
		$this->ExportPrintUrl = $this->PageUrl() . "export=print&" . "id_profile=" . urlencode($tbl_rank_stat->id_profile->CurrentValue) . "&stat_date=" . urlencode($tbl_rank_stat->stat_date->CurrentValue);
		$this->ExportHtmlUrl = $this->PageUrl() . "export=html&" . "id_profile=" . urlencode($tbl_rank_stat->id_profile->CurrentValue) . "&stat_date=" . urlencode($tbl_rank_stat->stat_date->CurrentValue);
		$this->ExportExcelUrl = $this->PageUrl() . "export=excel&" . "id_profile=" . urlencode($tbl_rank_stat->id_profile->CurrentValue) . "&stat_date=" . urlencode($tbl_rank_stat->stat_date->CurrentValue);
		$this->ExportWordUrl = $this->PageUrl() . "export=word&" . "id_profile=" . urlencode($tbl_rank_stat->id_profile->CurrentValue) . "&stat_date=" . urlencode($tbl_rank_stat->stat_date->CurrentValue);
		$this->ExportXmlUrl = $this->PageUrl() . "export=xml&" . "id_profile=" . urlencode($tbl_rank_stat->id_profile->CurrentValue) . "&stat_date=" . urlencode($tbl_rank_stat->stat_date->CurrentValue);
		$this->ExportCsvUrl = $this->PageUrl() . "export=csv&" . "id_profile=" . urlencode($tbl_rank_stat->id_profile->CurrentValue) . "&stat_date=" . urlencode($tbl_rank_stat->stat_date->CurrentValue);
		$this->AddUrl = $tbl_rank_stat->AddUrl();
		$this->EditUrl = $tbl_rank_stat->EditUrl();
		$this->CopyUrl = $tbl_rank_stat->CopyUrl();
		$this->DeleteUrl = $tbl_rank_stat->DeleteUrl();
		$this->ListUrl = $tbl_rank_stat->ListUrl();
